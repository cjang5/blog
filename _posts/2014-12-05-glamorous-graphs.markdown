...
<p> <img class="img-responsive" src="{{ site.baseurl }}/img/posts/post-06/united-states-mst.png" style="width:225px"> <img class="img-responsive" src="{{ site.baseurl }}/img/posts/post-06/europe.png" style="width:225px"> </p>
