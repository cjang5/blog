...
<img class="img-responsive" src="{{ site.baseurl }}/img/posts/post-06/united-states-mst.png" align="left" width:100%> <img class="img-responsive" src="{{ site.baseurl }}/img/posts/post-06/europe.png" align="middle"> <img class="img-responsive" src="{{ site.baseurl }}/img/posts/post-06/japan.png" align="right">
