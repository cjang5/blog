...
<img class="img-responsive" src="{{ site.baseurl }}/img/posts/post-06/united-states-mst.png" align="left" style="width:100%"> <img class="img-responsive" src="{{ site.baseurl }}/img/posts/post-06/europe.png" align="middle" style="width:100%"> <img class="img-responsive" src="{{ site.baseurl }}/img/posts/post-06/japan.png" align="right" style="width:100%">
